    ...
    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <a href="{{ route('tasks.create') }}" class="bg-green-500 hover:bg-green-700 text-blue font-bold py-2 px-4 rounded">Add Task</a>
            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 w-full">
                                ...
                                @foreach ($tasks as $task)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                           <img src=" {{ asset('uploads/students/' . $task->file) }}" width="100px;" height="100px;" alt="Image">
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <a href="{{ route('tasks.edit', $task->id) }}" class="text-indigo-600 hover:text-indigo-900 mb-2 ">Edit</a>
